...
use crate::views::{
    ...
    build_modal_container_view_with_layout, build_modal_view, build_nav_view_models,
    ...
    ContactsDirectoryViewModel, ModalContainerViewModel, ModalPlacement, ModalViewModel,
...
pub struct MacosViewTreeDescriptor {
    ...
    /// Kanban column liquid glass style.
    pub column_glass_style: MacosGlassStyle,
    /// Active tab.
...
impl MacosApp {
    ...
    pub fn build_view_tree(&self) -> MacosViewTreeDescriptor {
        ...
        let column_glass_style = glass.style_for(MacosContainerClass::KanbanColumn, app_theme);
